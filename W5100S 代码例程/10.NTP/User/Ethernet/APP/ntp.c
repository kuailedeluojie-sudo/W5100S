...
uint8 time_zone = 39;
uint8 ntp_server_ip[4]={202, 112,  10,  60};            /*北京市教育网*/
//uint8 ntp_server_ip[4]={210,  72, 145,  44};          /*中国国家授时中心(陕西西安)*/
//uint8 ntp_server_ip[4]={202, 120,   2, 101};          /*上海交通大学网络中心*/
